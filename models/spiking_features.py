...
class SpikingFeatures:
    ...
    Available features (as class attributes) are:

    * n_spikes
        The number of spikes.

    * spike_rate
        The spike rate is the number of spikes divided by stimulus duration.

    * latency_to_first_spike
        Latency to first spike; the time between stimulus onset and first spike
        occurrence.

    * average_AP_overshoot
        Average of the absolute peak voltage values of all action potentials.
    ...
    * accommodation_index
    ...
    def __init__(self, V, time, duration, t_stim_on, threshold=-55):
        """
        V : array_like
    ...
    def n_spikes(self):
        ...
        Number of action potentials (during stimulus period).
        """
    ...
    def spike_rate(self):
        ...
        Spike rate is calculated by dividing the number of spikes in the trace
        by the duration of the stimulus.

        Action-potential firing rate (number of action potentials divided by stimulus duration).
    ...
    def average_AP_overshoot(self):
        """Average action potential (AP) overshoot (mV).
    ...
    def average_AHP_depth(self):
        ...
        Average afterhyperpolarization depth (average minimum voltage between action potentials).
    ...
    def average_AP_width(self):
        ...
        Average action potential width taken at midpoint between the onset and peak of the action potential.
    ...
    def accommodation_index(self):
        """
        Accommodation index (normalized average difference in length of two consecutive interspike intervals).
