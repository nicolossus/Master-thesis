...
%------------------ contribution ---------------------
%\input{5_Chapters/Part0/3_Contrib}
%--------------------- code --------------------------
\input{5_Chapters/Part0/4_Code}
%------------------- notation  -----------------------
\input{5_Chapters/Part0/5_Notation}
%------------------- structure -----------------------
\input{5_Chapters/Part0/6_Structure}
...
%-------------- bayesian inference -------------------
\input{5_Chapters/Part1/1_Bayesian} 
\input{5_Chapters/Part1/2_Bayesian_Computation}  
\input{5_Chapters/Part1/2_LFI}
\input{5_Chapters/Part1/neuro} 
\input{5_Chapters/Part1/compneuro} 
%-------------------- examples -----------------------
%\input{5_Chapters/Part1/0_Examples} 
