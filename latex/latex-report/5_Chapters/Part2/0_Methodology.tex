...
Determining the tolerance parameter $\epsilon$ can be quite finicky.
...
We define the threshold as the $p$-quantile of the distances from from $N$ samples.
pyLFI has procedures for this. We only need to provide the $p$-quantile instead of $\epsilon$. Using the 0.5-quantile amounts to accepting 50\% of the simulations, the 0.3-quantile 30\% of the simulations and so on. 
