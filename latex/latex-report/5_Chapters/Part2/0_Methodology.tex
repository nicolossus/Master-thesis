...
To sample from the posterior, we must call the \cw{sample} method, which is specific for each algorithm. For the rejection ABC sampler when a pilot study is performed, the call becomes: 
